...
down_revision: Union[str, Sequence[str], None] = '5f65a3c4dc55'
...
def downgrade() -> None:
    ...
    op.add_column('users', sa.Column('verification_expires', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
